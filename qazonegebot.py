...
zoomMarkupru = types.InlineKeyboardMarkup( row_width = 1 )
...
skillcupMarkupru = types.InlineKeyboardMarkup( row_width = 1 )
skillcupButton1ru = types.InlineKeyboardButton(text='📱Инструкция по использованию Skill Cup', url='https://youtu.be/KUv0ytlDt1U')
skillcupButton2ru = types.InlineKeyboardButton(text='❌Мне не пришел пароль', url='tiny.cc/skillcup')
skillcupMarkupru.add(skillcupButton1ru, skillcupButton2ru, gobackButtonru)
...
zoomMarkupkz = types.InlineKeyboardMarkup( row_width = 1)
...
skillcupMarkupkz = types.InlineKeyboardMarkup(row_width = 1)
skillcupButton1kz = types.InlineKeyboardButton(text = '📱Skill Cup қолданау нұсқаулық', url='https://youtu.be/J0fs6lYbge4')
skillcupButton2kz = types.InlineKeyboardButton(text='❌Маған пароль келген жоқ', url='tiny.cc/skillcup')
skillcupMarkupkz.add(skillcupButton1kz, skillcupButton2kz, gobackButtonkz)
